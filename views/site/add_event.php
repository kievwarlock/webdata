...
<div class="content-window-inner">
    ...
    <div class="window-description">
        ...
        if ($current_user) {
            ...
            <p>
                Selected user: <?=$current_user['phone']?>
            </p>
        ...
        <form class="navbar-form" action="/event/add" method="get">
            <div class="form-group">
                <select name="id" class="user-select form-control">
                    ...
                    <?php foreach ($all_users as $all_user) { ?>
                        ...
                        <option <?= ($all_user['profile_id'] == $current_user_id) ? 'selected=selected' : ''; ?> value="<?= $all_user['profile_id'] ?>">
                            <?= $all_user['phone'] ?>
                        </option>
